#this is an intential vulnerable codebase  written to demonstrate sql injection 
...
def login(username, password):
    #the  string cancentation below is intentionally written this way to allow  input of a  suspicious SQL Syntax
    q = f"SELECT user, role FROM users WHERE user = '{username}' AND pass = '{password}'"
    print("RUNNING:", q)
